...
func NewCommand(logger log.Logger, streams cmd.IOStreams) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Use:   "krustlet-image",
		Short: "Build the krustlet image",
		Long:  "Build the krustlet image which contains Kubernetes build artifacts and other kind requirements",
